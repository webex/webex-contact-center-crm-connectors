...
| File | Description |
| --- | --- |
| [`Cisco_CCIF_EA_updateset_1.0.0.xml`](./Cisco_CCIF_EA_updateset_1.0.0.xml) | ServiceNow update set XML for the Cisco Webex Contact Center application scope `x_caci_crm_wxcc_vx`, version `1.0.0` |
...
- Provides the packaged ServiceNow records that accompany the early-access CCIF implementation path.

## Import guidance

1. In ServiceNow, open **System Update Sets > Retrieved Update Sets**.
2. Choose **Import Update Set from XML**.
3. Upload [`Cisco_CCIF_EA_updateset_1.0.0.xml`](./Cisco_CCIF_EA_updateset_1.0.0.xml).
